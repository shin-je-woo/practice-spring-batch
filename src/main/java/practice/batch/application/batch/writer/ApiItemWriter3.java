...
public class ApiItemWriter3 extends FlatFileItemWriter<ApiRequest> {
    ...
    public void write(@Nonnull Chunk<? extends ApiRequest> chunk) throws Exception {
        ...
        super.setResource(new FileSystemResource("/Users/jewoo/IdeaProjects/practice-spring-batch/src/main/resources/application_files/write/product3.csv"));
